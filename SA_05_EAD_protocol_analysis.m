...
load SA_ICs_matrix_1000_s0p1_Ach0p1
...
exp_Ach = 1%; % (boolean - 0.1 uM if exp_Ach = 1)
...
parfor ii=1:N_trials
    ...
    for i=1:length(tin)
        EAD_index(i) = function_EAD_occurrence(time,Vm,tin(i));
    end
...
%% Saving
%save SA_EAD_outputs_matrix_1000_s0p1 all_outputs
